...
public class PowerUp : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Vector3 vel = Random.onUnitSphere; // Get Random XYZ velocity Random.onUnitSphere
    ...
    void Update()
    {
        cube.transform.rotation = Quaternion.Euler(rotPerSecond * Time.time); //Fade out the PowerUp over time Given the default values
